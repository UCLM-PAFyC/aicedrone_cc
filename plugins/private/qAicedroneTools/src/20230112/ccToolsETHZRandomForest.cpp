...
//        const auto& color =ptrCloud->getPointColor(i);
    ...
    while(iterByClass!=featuresByClassByParameter.end())
    {
        ...
        outputFileAllHeader+=",";
        outputFileAllHeader+=(className+"_minn");
        outputFileAllHeader+=",";
    ...
    while(iterByParameter!=meanValueByParameterByClass.end())
    {
        ...
        while(iterByClass!=iterByParameter.value().end())
        {
            ...
            QString strMeanValue=QString::number(meanValue,'f',6);
            QString strStdValue=QString::number(stdValue,'f',6);
            QString strMinValue=QString::number(minValue,'f',6);
            QString strMaxValue=QString::number(maxValue,'f',6);
