...
//! Example qCC plugin
/** Replace 'ExamplePluginDHL' by your own plugin class name throughout and then
	check 'ExamplePluginDHL.cpp' for more directions.
...
**/
class ExamplePluginDHL : public QObject, public ccStdPluginInterface
{
	Q_OBJECT
	...
	Q_PLUGIN_METADATA( IID "cccorp.cloudcompare.plugin.ExampleDHL" FILE "../info.json" )

public:
	explicit ExamplePluginDHL( QObject *parent = nullptr );
	~ExamplePluginDHL() override = default;
