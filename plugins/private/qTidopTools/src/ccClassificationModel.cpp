...
void ccClassificationModel::createDefaultItems()
{
    ...
    if(m_modelName.compare(CC_CLASSIFICATION_MODEL_IBERDROLA_NAME,
                         Qt::CaseInsensitive)==0)
    {
        settings.beginGroup(CC_CLASSIFICATION_MODEL_PERSISTENCE_TAG_IBERDROLA);
        {
            AddClass(settings, "Removed",				        CC_CLASSIFICATION_MODEL_REMOVED_CODE, qRgb(255, 255, 255));
            AddClass(settings, "Selected",				        CC_CLASSIFICATION_MODEL_SELECTED_CODE, qRgb(0, 255, 255));
            AddClass(settings, "Not classified",				 CC_CLASSIFICATION_MODEL_IBERDROLA_NOT_CLASSIFIED_CODE, qRgb(255, 0, 255));
            AddClass(settings, "Unclassified",					 CC_CLASSIFICATION_MODEL_IBERDROLA_UNCLASSIFIED_CODE, qRgb(170, 170, 170));
            AddClass(settings, "Floor",				             0, qRgb(200,130,55));
            AddClass(settings, "TowerBase",					     1, qRgb(120, 100, 90));
            AddClass(settings, "Insulators",					 2, qRgb(0,0,255));
            AddClass(settings, "Wires",				             3, qRgb(128, 128, 128));
            AddClass(settings, "TransmissionTower",				 4, qRgb(0,255,0));
            AddClass(settings, "CircuitBreaker",				 5, qRgb(255,150,0));
            AddClass(settings, "BusPipes",						 6, qRgb(255,255,0));
            AddClass(settings, "Bushings",						 7, qRgb(255,0,0));
            AddClass(settings, "Fence",				             8, qRgb(38,75,22));
//            AddClass(settings, "Other",							 9, qRgb(9,245,241));
        }
        settings.endGroup();
        m_noiseCode=CC_CLASSIFICATION_MODEL_IBERDROLA_NOISE_CODE;
    }
...
//            AddClass(settings, "Removed",				        CC_CLASSIFICATION_MODEL_REMOVED_CODE, qRgb(255, 255, 255));
//            AddClass(settings, "Selected",				        CC_CLASSIFICATION_MODEL_SELECTED_CODE, qRgb(0, 255, 255));
//            AddClass(settings, "Not classified",				 CC_CLASSIFICATION_MODEL_RAILWAY_NOT_CLASSIFIED_CODE, qRgb(255, 0, 255));
//            AddClass(settings, "Unclassified",					 CC_CLASSIFICATION_MODEL_RAILWAY_UNCLASSIFIED_CODE, qRgb(170, 170, 170));
////            AddClass(settings, "Floor",				             0, qRgb(200,130,55));
...
void ccClassificationModel::load()
{
    ...
    else if(m_modelName.compare(CC_CLASSIFICATION_MODEL_ARCHDATASET_NAME,
                                Qt::CaseInsensitive)==0)
    {
        persistenceTag=CC_CLASSIFICATION_MODEL_PERSISTENCE_TAG_ARCHDATASET;
    }
    else if(m_modelName.compare(CC_CLASSIFICATION_MODEL_IBERDROLA_NAME,
                                Qt::CaseInsensitive)==0)
    {
        persistenceTag=CC_CLASSIFICATION_MODEL_PERSISTENCE_TAG_IBERDROLA;
    }
