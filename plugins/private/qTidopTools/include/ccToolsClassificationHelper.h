...
public:
    ...
    RGBAColorsTableType* getOriginalColors(){return(m_ptrFormerCloudColors);};
...
private: // variables
	...
	public:
        ...
        void update(ScalarType code, ccColor::Rgba color)
		{
			this->code = code;
			this->color = color;
		}
    ...
    std::vector<ccColor::Rgba> m_cloudOriginalRGB;
