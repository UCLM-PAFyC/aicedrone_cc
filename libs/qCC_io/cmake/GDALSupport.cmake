		...
		file( GLOB GDAL_DLL_FILES ${GDAL_BIN_DIR}/gdal*.dll )
                ...
                elseif (GDAL_VERSION EQUAL 3.5)
                    set ( GDAL_DEP_DLL_FILES ${GDAL_BIN_DIR}/xerces-c_3_2.dll
                        ...
                        # for pdal
                        #${GDAL_BIN_DIR}/laszip3.dll
                        ${GDAL_BIN_DIR}/ogdi.dll #DHL
                        ${GDAL_BIN_DIR}/szip.dll #DHL
                        ${GDAL_BIN_DIR}/jpeg62.dll #DHL
                        ${GDAL_BIN_DIR}/libmysql.dll #DHL
                        ${GDAL_BIN_DIR}/iconv-2.dll #DHL
                        ${GDAL_BIN_DIR}/webp.dll #DHL
                        ${GDAL_BIN_DIR}/arrow.dll #DHL
                        ${GDAL_BIN_DIR}/parquet.dll #DHL
                        ${GDAL_BIN_DIR}/proj_9_0.dll #DHL
                        ${GDAL_BIN_DIR}/thriftmd.dll #DHL
                        ${GDAL_BIN_DIR}/brotlidec.dll #DHL
                        ${GDAL_BIN_DIR}/brotlienc.dll #DHL
                        ${GDAL_BIN_DIR}/brotlicommon.dll #DHL
                        # for pdal
                        ${GDAL_BIN_DIR}/liblas.dll #DHL
                        ${GDAL_BIN_DIR}/liblas_c.dll #DHL
                        ${GDAL_BIN_DIR}/libpdal_plugin_kernel_fauxplugin.dll #DHL
                        ${GDAL_BIN_DIR}/libpdal_plugin_reader_pgpointcloud.dll #DHL
                        ${GDAL_BIN_DIR}/libpdal_plugin_writer_pgpointcloud.dll #DHL
                        ${GDAL_BIN_DIR}/pdal_util.dll #DHL
                        ${GDAL_BIN_DIR}/pdalcpp.dll #DHL
                        # ${GDAL_BIN_DIR}/.dll #DHL
                        # ${GDAL_BIN_DIR}/.dll #DHL
                        ${GDAL_BIN_DIR}/laszip3.dll
                        )
                elseif (GDAL_VERSION EQUAL 3.7)
                    set ( GDAL_DEP_DLL_FILES ${GDAL_BIN_DIR}/xerces-c_3_2.dll
                        ${GDAL_BIN_DIR}/libexpat.dll
                        ${GDAL_BIN_DIR}/LIBPQ.dll
                        ${GDAL_BIN_DIR}/hdf.dll
                        ...
                        ${GDAL_BIN_DIR}/pdal_util.dll #DHL
                        ${GDAL_BIN_DIR}/pdalcpp.dll #DHL
                        ${GDAL_BIN_DIR}/jxl.dll #DHL
                        ${GDAL_BIN_DIR}/jxl_threads.dll #DHL
                        ${GDAL_BIN_DIR}/arrow_dataset.dll #DHL
                        # ${GDAL_BIN_DIR}/.dll #DHL
                        # ${GDAL_BIN_DIR}/.dll #DHL
                        # ${GDAL_BIN_DIR}/laszip3.dll
                        )
